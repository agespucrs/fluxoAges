...
public class MensagemContantes {
	...
	public static final String MSG_SUC_CADASTRO_USUARIO = "Cadastro usu�rio: ?, efetuado com sucesso!";
	...
	public static final String MSG_SENHA_INVALIDA = "A senha do usuario � invalida: Deve ter no minimo 3 e no maximo 8 caracteres, apenas numeros e letras!";
